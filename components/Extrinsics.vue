        ...
        <div v-else class="mb-6">
            ...
            <div class="flex mt-8 gap-4">
                <button @click="submitExtrinsic" :disabled="!canSubmit || submitting"
                    class="px-12 py-2 border-2 border-white/50 hover:border-white bg-gradient-to-br hover:bg-gradient-to-l from-[#00B7FF] via-[#00DFD4] to-[#00FF95] font-medium text-lg text-white rounded-md disabled:bg-gray-400">
